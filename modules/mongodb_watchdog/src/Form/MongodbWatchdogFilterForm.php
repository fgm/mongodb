...
/**
 * Provides the MongodbWatchdog logging filter form.
 */
class MongodbWatchdogFilterForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($filters as $name => $filter) {
      if ($form_state->hasValue($name)) {
        $_SESSION['mongodb_watchdog_overview_filter'][$name] = $form_state->getValue($name);
      }
    }
  }
